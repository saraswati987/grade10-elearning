    ...
    >
      ...
      <div>
        ...
        <ul class="mb-6 flex flex-col gap-1.5">
          ...
          <li>
            <a
              class="<?php echo $_SERVER['REQUEST_URI'] == "/grade10-elearning/admin/index.php" ? "bg-graydark dark:bg-meta-4" : "" ?> group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4"
            ...
            <!-- Dropdown Menu Start -->          </li>
          <!-- Menu Item Dashboard -->

          <!-- Menu Item Calendar -->
          <li>
            <a
              class="<?php echo $_SERVER['REQUEST_URI'] == "/grade10-elearning/admin/course.php" ? "bg-graydark dark:bg-meta-4" : "" ?>  group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4"
              href="/grade10-elearning/admin/course.php"
            >
      ...
      >
        ...
        >
          ...
          <a
            ...
            href="/grade10-elearning/admin/logout.php"
          >
            <svg
              class="fill-current"
              width="22"
