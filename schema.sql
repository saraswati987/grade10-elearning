...
(1, 'Hari Sharma (Teacher)', 'teacher@school.edu.np', '$2y$10$MdfK6UTtQ6J.hNEUzSQw5.ytNA6YF0MIMS.kvkfb.3cP.4mVbrBWG', 'teacher', NULL),
(2, 'Aarav Adhikari (Student)', 'student@school.edu.np', '$2y$10$MdfK6UTtQ6J.hNEUzSQw5.ytNA6YF0MIMS.kvkfb.3cP.4mVbrBWG', 'student', '10-01'),
(3, 'Sita Thapa (Student)', 'sita@school.edu.np', '$2y$10$MdfK6UTtQ6J.hNEUzSQw5.ytNA6YF0MIMS.kvkfb.3cP.4mVbrBWG', 'student', '10-02');

-- Seed Subjects
INSERT IGNORE INTO `subjects` (`id`, `code`, `name`, `description`, `icon`) VALUES
...
(1, 1, 'Trigonometry Formulas & Proofs', 'Comprehensive list of Grade 10 trigonometric identities and solved model questions.', 'text', NULL, 'Key Formulas:\n1. sin^2(A) + cos^2(A) = 1\n2. 1 + tan^2(A) = sec^2(A)\n3. 1 + cot^2(A) = cosec^2(A)\n\nHeight and Distance tips:\nAlways draw the right-angled triangle first and label the angle of elevation or depression.', 1),
(2, 2, 'Laws of Motion & Force Notes', 'Newton\'s laws of motion explained with everyday examples and SEE numerical problems.', 'text', NULL, 'First Law of Motion: An object remains at rest or in uniform motion unless acted upon by an external unbalanced force (Law of Inertia).\n\nSecond Law: Force = mass x acceleration (F = m x a).\n\nThird Law: For every action, there is an equal and opposite reaction.', 1),
(3, 3, 'C Programming Quick Reference', 'Syntax guide for loops, variables, conditional statements, and standard I/O for Grade 10.', 'text', NULL, 'C Program Structure:\n#include <stdio.h>\nint main() {\n    printf("Hello Grade 10 Students!");\n    return 0;\n}', 1);
